...
@section('content')
    <div class="card mx-auto shadow-sm"
        style="max-width: 500px; margin-top: 40px; margin-bottom: 40px; border-radius: 0.5rem;">
            ...
            <form method="POST" action="{{ route('admin.profile.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" name="username"
                        value="{{ old('username', $admin->username) }}" readonly style="background-color: #e9ecef; color: #6c757d;>
                </div>

                <div class="mb-3">
                    <label class="form-label">Email</label>
                    <input type="email" class="form-control form-control-sm" name="email"
                        value="{{ old('email', $admin->email) }}" readonly style="background-color: #e9ecef; color: #6c757d;>
                </div>
