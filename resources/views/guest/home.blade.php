...
@section('content')
    ...
    <section id="hero" class="py-5 text-center bg-light border-bottom" 
        ...
        <div class="container">
            <h1 class="display-4 fw-bold mb-3 text-dark">Welcome to Music Studio</h1>
            <p class="lead text-muted mb-4">Book your rehearsal room now!</p>
    ...
    <section id="promotions" class="py-5">
        <div class="container">
            ...
            @if($promotions->isEmpty())
                <div class="alert alert-secondary text-center shadow-sm rounded-3">No promotions currently.</div>
            @else
                <div class="row g-4">
        ...
        <div class="container">
            ...
            <form method="GET" action="{{ route('home') }}" 
                ...
                <div class="col-md-2 d-flex gap-2">
                    <button type="submit" 
                            class="btn btn-primary shadow-sm w-100 d-flex align-items-center justify-content-center"
                            style="height: 2.75rem;">
                        <i class="bi bi-funnel me-1"></i> Filter
                    </button>
                    <a href="{{ route('home') }}" 
                    class="btn btn-outline-secondary shadow-sm w-100 d-flex align-items-center justify-content-center"
                    style="height: 2.75rem;">
            ...
            @if($rooms->isEmpty())
                <div class="alert alert-warning text-center shadow-sm rounded-3">No rooms available.</div>
            @else
                <div class="row g-4">
