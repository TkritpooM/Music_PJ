...
<div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card shadow-lg p-4" 
        ...
        <h2 class="text-center mb-4 fw-bold text-dark">Forgot Password</h2>

        @if(session('success'))
            <div class="alert alert-success p-2 mb-3 shadow-sm rounded-2">
                {{ session('success') }}
            </div>
        @endif
        ...
        <form method="POST" action="/forgot-password">
            ...
            <div class="mb-3">
                ...
                <div class="input-group input-group-sm shadow-sm">
                    ...
                    <input type="email" class="form-control border-0" id="email" name="email" placeholder="Enter your email" value="{{ old('email') }}">
                </div>
            </div>

            <button type="submit" class="btn btn-primary w-100 shadow-sm" style="height: 2.75rem;">
                <i class="bi bi-envelope-paper-fill me-1"></i> Send Reset Link
            </button>
        </form>
